...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    private function configureViews(): void
    {
        Fortify::loginView(fn (Request $request) => view('pages::auth.login', [
            'workspaceInvitation' => $this->workspaceInvitation($request),
        ]));
    ...
    /**
     * Get the pending workspace invitation context for auth pages.
     *
     * @return array{code: string, workspaceName: string}|null
     */
    private function workspaceInvitation(Request $request): ?array
    {
