...
<div class="space-y-3 transition-transform duration-150"
  data-department-tree-name="{{ $department->name }}"
  ...
  <div class="flex items-start gap-3">
    ...
    <div
      class="flex min-w-0 flex-1 cursor-grab items-center justify-between gap-3 rounded-md bg-zinc-100 px-5 py-2 transition-all duration-150 active:cursor-grabbing dark:bg-zinc-800/70"
      draggable="true"
      x-on:dragstart="
      ...
      x-on:dragleave="if (dropDepartmentId === {{ $department->id }}) dropDepartmentId = null"
      x-on:drop.prevent="
