...
<flux:dropdown position="bottom" align="end">
    <button
        type="button"
        class="inline-flex h-12 cursor-pointer items-center gap-1 px-3 text-sm font-medium text-zinc-600 transition hover:bg-zinc-100 hover:text-zinc-950 dark:text-zinc-300 dark:hover:bg-zinc-950 dark:hover:text-white"
    ...
    <flux:menu class="min-w-28">
        @foreach ($locales as $code => $label)
            <flux:menu.item
                ...
                data-test="language-switcher-item"
            >
